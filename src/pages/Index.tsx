    ...
    <div className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full bg-background/95 backdrop-blur-lg border-b border-border z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-primary">househelp</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-6 md:space-y-8">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Manage House Help <span className="text-accent">Attendance & Salary</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed">
                Track daily attendance, calculate salaries automatically, and get AI-powered insights. Simple, accurate,
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6 pt-4">
                  ...
                  <div className="flex -space-x-3">
                    {avatars.map((avatar, i) => (
                      <img
                        ...
                        src={avatar}
                        alt={`User ${i + 1}`}
                        className="w-10 sm:w-12 h-10 sm:h-12 rounded-full border-3 border-background shadow-lg animate-fade-in hover:scale-110 transition-transform duration-300 object-cover"
                        style={{
                ...
                <div
                  className="text-center sm:text-left animate-fade-in"
                  style={{
                    animationDelay: "0.5s",
                  }}
                >
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-base md:text-lg text-muted-foreground">
                Say goodbye to messy notebooks and error-prone spreadsheets. Track everything digitally with smart
                features designed for modern households.
              </p>
            ...
            <div className="relative mt-8 lg:mt-0">
              <Card
                className="p-6 md:p-8 border-2 border-accent/20 bg-card"
                style={{
                  boxShadow: "var(--shadow-elegant)",
                }}
              >
                <CardContent className="space-y-4 md:space-y-6 p-0">
                  ...
                  <div className="space-y-2" ref={accuracyCounter.ref}>
                    ...
                    <p className="text-3xl md:text-5xl font-bold text-accent tabular-nums">{accuracyCounter.count}%</p>
                  </div>
      ...
      <section className="py-12 md:py-20 px-4 relative overflow-hidden bg-card border-y border-border">
        ...
        <div className="container mx-auto relative z-10 text-center space-y-6 md:space-y-8">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">Get Early Access</h2>
          <p className="text-base md:text-xl text-muted-foreground max-w-2xl mx-auto px-4">
            Join 1,000+ households using househelp to track attendance and manage salaries effortlessly. Sign up to be
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4 justify-center px-4 pt-4">
            <Button
              ...
              variant="outline"
              asChild
              className="text-base md:text-lg px-6 md:px-8 border-2 hover:bg-primary hover:text-primary-foreground hover:border-primary transition-colors w-full sm:w-auto"
            >
              <a
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-muted-foreground">Smart attendance & salary management</p>
            </div>
            ...
            <div className="flex items-center gap-6 text-sm text-muted-foreground">
              ...
              <a href="mailto:support@househelp.com" className="hover:text-primary transition-colors">
                Contact
              </a>
            </div>
          </div>
